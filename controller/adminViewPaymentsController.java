...
import eStoreProduct.DAO.AdminViewPaymentDAOImp;
import eStoreProduct.model.AdminViewPayments;

@Controller
public class adminViewPaymentsController {
    private final AdminViewPaymentDAOImp adminPayment;

    @Autowired
    public adminViewPaymentsController(AdminViewPaymentDAOImp adminPayment) {
